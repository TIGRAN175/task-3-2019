...
namespace RTS_game
{
    public class wizard: UNIT
    {
        ...
        public wizard(int x, int y, int maxH, int health, int speed, int atk, int faction, string symbol, string Uname)
        {
            Xpos = x;
            Ypos = y;
            Health = health;
        ...
        public override void Combat(UNIT attacker)
        {
            ...
            {
                Health = Health - ((wizard)attacker).Attack;
            }
        ...
        public override bool IsInRange(UNIT other)
        {
            ...
            if (other is wizard)
            {
                otherX = ((wizard)other).Xpos;
                otherY = ((wizard)other).Ypos;
            }
